    ...
    <div class="profile-outer">
      <b-container>
        <div class="profile-inner">
          <div class="owner-pic">
            <img src="../assets/images/lawyer-card/member2.jpg" height="170" width="264" alt />
          </div>
            ...
            <b-tabs pills card vertical>
              ...
              <b-tab>
                <template v-slot:title>
                  ...
                  <span class="user__profile-card-text">Telefon konsultatsiya</span>
                  <font-awesome-icon :icon="['fas', 'angle-right']" />
                </template>
                <b-card-text>
              ...
              <b-tab>
                <template v-slot:title>
                  ...
                  <span class="user__profile-card-text">Hujjat buyurtmalarim</span>
                  <font-awesome-icon :icon="['fas', 'angle-right']" />
                </template>
                        ...
                        <form action method="POST" class="user__profile-form">
                          <b-row>
                            <b-col md="12">
                              <p>Rasm</p>
                              <label for="image">
                                <img src="../assets/images/avatar.png" alt class="avatar__image" />
                                <input
                                  type="file"
                            ...
                            <b-col lg="6">
                              <label for="user__profile-number">Telefon raqam</label>
                              <input type="text" id="user__profile-number">
                            </b-col>
                            <b-col lg="12">
                              <b-button type="submit"><font-awesome-icon :icon="['fas','save']" />Saqlash</b-button>
                              <b-button type="submit"><font-awesome-icon :icon="['fas','remove']" />Bekor qilish</b-button>
                            </b-col>
                          </b-row>
                        </form>
                      </b-col>
