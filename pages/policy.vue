...
<p style="text-align: center">
    <strong>SH A R T N O M A</strong> <br>
(Saytdan foydalanish to’grisida “ommaviy oferta”)
</p> 
...
<p class="text-center">
    <strong>1.Asosiy tushunchalar</strong>
</p>
<p class="policy__indent"> <strong> Foydalanuvchi </strong>– saytdan va uning funksiyalaridan foydalanishni boshlagan yoki mijoz yoki 
    yurist sifatida ro’yxatdan o’tgan har qanday yuridik va jismoniy shaxs.

<p class="policy__indent"> <strong> Mijoz </strong> - xizmatlardan foydalanish maqsadida saytdan
 ro’yxatdan o’tgan foydalanuvchi. </p>

<p class="policy__indent"> <strong> Mutaxassis </strong> – saytda yurist, advokat yoki advokatlik 
tuzilmasi sifatida ro’yxatdan o’tgan foydalanuvchi.</p>

<p class="policy__indent"> <strong>Freelancer (shtatsiz ishchi)</strong>  – sayt va ijtimoiy tarmoqlar 
    orqali o’z xizmatkarini taklif qiluvchi mutaxassis. 
</p>
<p class="policy__indent"> <strong>Sayt </strong>(yoki sayt ma’muriyat) – “Legal Help” mas’uliyati cheklangan 
jamiyati, Toshkent shahri, Bektemir tumani, Davlat Xizmatlari Markazi tomonidan
 ro’yxatga olingan. STIR: 000000000, yuridik manzil: Toshkent shahri, Bektemir
  tumani, Oltintopgan MFY, J.Toshkandiy ko’chasi, 40-uy 6-xonadon;
</p>
<p class="text-center">
    <strong>2. Aksеpt tartibi</strong>
</p>

<p class="policy__indent">2.1. Ommaviy Oferta aksepti foydalanuvchini saytda ro‘yxatga olish yo‘li bilan amalga oshiriladi. 
    Sayt iOS, Android platformalarida va www.legalhelp.uz manzili bo‘yicha ishlaydi. Oferta aksepti amalga oshirilgan paytdan boshlab
     shartnoma tuzilgan hisoblanadi.
</p>
<p class="policy__indent"> 2.2. Foydalanuvchi ushbu shartnomada keltirilgan shartlarga rozi bo‘lmasa, saytdan foydalanishni to’xtatishi lozim.
</p>
<p class="text-center">
    <strong>3. Shartnoma predmeti</strong>
</p>

<p class="policy__indent">3.1. Ushbu shartnomaga muvofiq, mijoz sayt tomonidan taqdim etiladigan xizmatlardan foydalanish va ko’rsatilgan xizmatlar uchun haq to’lash majburiyatini oladi, mutaxassis (freelancer) saytdan foydalangan holatda yuridik konsalting xizmatlarini ko’rsatish va ko’rsatilgan xizmatlar uchun haq olish huquqiga ega. Ma’muriyat foydalanuvchilarga sayt imkoniyatlaridan haq evaziga foydalanish imkoniyatini taqdim etadi.
</p>
<p class="policy__indent">3.2. Shartnomada to‘g‘ridan-to‘g‘ri nazarda tutilmagan barcha holatlar bo‘yicha tomonlar O‘zbekiston Respublikasining amaldagi qonun hujjatlari va ish muomalasi odatlariga amal qiladilar. Quyidagi hujjatlar mazkur shartnomaning tarkibiy qismi hisoblanadi hamda ushbu shartnomaning foydalanuvchi tomonidan aksept qilinishi ushbu hujjatlarning ham qabul qilinganligini anglatadi:
- https://legalhelp.uz/policies/terms-legal-services/ manzili bo’yicha joylashtirilgan www.legalhelp.uz saytida yuridik xizmatlarni ko’rsatish qoidalari; - https://legalhelp.uz/policies/confidential/ manzili bo’yicha joylashgan “Ma’lumotlar maxfiyligi qoidalari”; Ushbu hujjatlar (shu jumladan, ularning biror qismi) bir tomonlama ravishda Sayt tomonidan ogohlantirilmasdan istalgan vaqtda o’zgartirilishi mumkin. Agar hujjatlarning yangi tahrirlarida boshqacha qoida nazarda tutilmagan bo'lsa, hujjatlarning yangi nusxalari ular chiqarilgan paytdan e'tiboran kuchga kiradi. Foydalanish shartnomasiga o‘zgartirish va qo‘shimchalar kiritilganidan keyin ham Foydalanuvchining Sayt xizmatlaridan foydalanishda davom etishi kiritilgan o‘zgartirish va qo‘shimchalarning uning tomonidan qabul qilinganligini anglatadi.

<p class="policy__indent">3.3. Foydalanuvchi saytda ro‘yxatdan o‘tgunga qadar foydalanish shartnomasi bilan to‘liq tanishib chiqishi shart. Foydalanuvchining Saytda ro‘yxatdan o‘tishi O‘zbekiston Respublikasi Fuqarolik kodeksining 364, 365,369 va 370-moddalariga muvofiq Foydalanish shartnomasiga to‘liq va so‘zsiz rioya qilishini anglatadi.
<p class="policy__indent">3.4. Mazkur shartnoma ochiq va ommaga mo‘ljallangan hujjat hisoblanadi. Foydalanish bo‘yicha kelishuvning amaldagi tahriri Internet tarmog‘ida quyidagi manzilda joylashtiriladi: https://legalhelp.uz/policies/terms/
</p>
<p class="text-center">
    <strong>4. Sayt maqomi</strong>
</p>
<p class="policy__indent">4.1. Sayt o‘zida axborot tizimidagi EHM uchun dasturlar va ma’lumotlar yig‘indisini aks ettiradigan, bunday ma’lumotlarni Internet tarmog‘idagi https://legalhelp.uz manzilida ochiq joylashtirilishini ta’minlaydigan Internet resursi  axborot vositachisi hisoblanadi.
</p>
<p class="policy__indent">4.2. https://legalhelp.uz (domen nomi) tarmoq manzili va undan foydalanish bilan bog‘liq barcha huquqlar Sayt ma’muriyatiga tegishli. Saytdan manfaatdor shaxslarning foydalanishiga yo‘l qo‘yilishi O‘zbekiston Respublikasining amaldagi qonun hujjatlari hamda foydalanish shartnomasiga muvofiq belgilanadi.
</p>
<p class="policy__indent">4.3. Saytning alohida bo‘limlarida foydalanuvchi va boshqa shaxslar tomonidan mustaqil joylashtirilgan (adabiy, musiqiy, audiovizual asarlar va fonogrammalar, grafika, dizayn va fotosurat mahsulotlari, EHM uchun dasturlardan tashqari) ma’lumotlar va intellektual faoliyat natijalaridan foydalanish huquqi foydalanuvchi yoki boshqa shaxslarga tegishli hisoblanadi.
</p>
<p class="policy__indent">4.4. Jismoniy va yuridik shaxslar mazkur Foydalanish shartnomasi bo’yicha yoki sayt ish faoliyati bilan bog‘liq murojaat, taklif va shikoyatlari, shuningdek vakolatli davlat organlarining so‘rovnomalari mazkur shartnomaning 9-bandida ko‘rsatilgan “Legal Help” MCHJning pochta manzili yoki @legalhelp.uz elektron pochta manzili orqali qabul qilinadi.
</p>
<p class="policy__indent">4.5. Ushbu Foydalanish shartnomasi har qanday holatda foydalanuvchiga firma nomi, tovar belgisi, domen nomi va Sayt ma’muriyatining boshqa taniqli belgilaridan foydalanish huquqini bermaydi. Firma nomi, tovar belgisi, domen nomi va sayt ma’muriyatining boshqa taniqli belgilaridan foydalanish huquqi sayt ma’muriyatining yozma roziligi bilan taqdim etilishi mumkin.
</p>
<p class="policy__indent">4.6. Ma’muriyat tomonidan Sayt faoliyatini yuritish va uni rivojlantirish O‘zbekiston Respublikasining qonun hujjatlariga muvofiq amalga oshiriladi. 
</p>
<p class="policy__indent">4.7. Mazkur Foydalanish shartnomasi har qanday holatda ham foydalanuvchiga firma nomi, tovar belgisi, domen nomi va Sayt ma’muriyatining boshqa taniqli belgilaridan foydalanish huquqini bermaydi. Istisno tariqasida, firma nomi, tovar belgisi, domen nomi va sayt ma’muriyatining boshqa taniqli belgilaridan foydalanish huquqi sayt ma’muriyatining yozma roziligi bilan taqdim etilishi mumkin.
</p>
<p class="text-center">
    <strong>5. Tomonlarning huquq va majburiyatlari</strong>
</p>
<p class="policy__indent">
